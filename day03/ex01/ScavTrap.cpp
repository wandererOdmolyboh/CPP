...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/11 09:55:10 by dmolyboh          #+#    #+#             */
/*   Updated: 2019/09/11 09:55:18 by dmolyboh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double ScavTrap::Get_Hit_points()
{
    return (Hit_points);
}

double ScavTrap::Get_Max_hit_points()
{
    return (Max_hit_points);
}

double ScavTrap::Get_Energy_points()
{
    return (Energy_points);
}

double ScavTrap::Get_Max_energy_points()
{
...
double ScavTrap::Get_Melee_attack_damage()
{
    return (Melee_attack_damage);
}

double ScavTrap::Get_Ranged_attack_damage()
{
    return(Ranged_attack_damage);
}

double ScavTrap::Get_Armor_damage_reduction()
{
